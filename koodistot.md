...
## Kaavamääräys
{% include common/clause_start.html type="req" id="prof-ak/vaat-kaavamaarays" %}
...
{% include common/clause_start.html type="req" id="prof-ak/vaat-kaavamaarayksen-lisatieto" %}
