...
{% include common/clause_start.html type="req" id="sp-ak/vaat-etaisyys-naapuritontin-rajasta-lisatiedot" %}
...
{% include common/clause_start.html type="req" id="sp-ak/vaat-rakennettava-kiinni-rajaan-lisatiedot" %}
```lisatieto```-attribuutilla ei saa olla arvoja.
{% include common/clause_end.html %}
...
{% include common/clause_start.html type="req" id="sp-ak/vaat-liitettava-kaukolampoverkkoon-maar" %}
Ilmaisee, että {% include common/moduleLink.html moduleId="kaavatiedot" path="dokumentaatio/#kaavakohde" title="Kaavakohde" %} kuvaa alueen, joka on liitettävä kaukolämpöverkkoon.
{% include common/clause_end.html %}

{% include common/clause_start.html type="req" id="sp-ak/vaat-liitettava-kaukolampoverkkoon-arvot" %}
```arvo```-attribuutilla ei saa olla arvoja.
{% include common/clause_end.html %}

{% include common/clause_start.html type="req" id="sp-ak/vaat-liitettava-kaukolampoverkkoon-lisatiedot" %}
```lisatieto```-attribuutilla ei saa olla arvoja.
{% include common/clause_end.html %}
-->